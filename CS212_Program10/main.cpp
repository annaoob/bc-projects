...
// Verify some edges
			new HasEdgeCommand("A", "C", false), new HasEdgeCommand("A", "E",
					false), new HasEdgeCommand("B", "C", true),
			new HasEdgeCommand("C", "A", true), new HasEdgeCommand("C", "B",
					false), new HasEdgeCommand("C", "D", true),
			new HasEdgeCommand("C", "E", true), new HasEdgeCommand("D", "C",
					true), new HasEdgeCommand("E", "A", true),
			new HasEdgeCommand("E", "C", false), new HasEdgeCommand("E", "D",
					true)
	};
